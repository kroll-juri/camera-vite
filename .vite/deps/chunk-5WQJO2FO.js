          ...
          0 !== queue.length &&
            queueSeveralMicrotasks(function () {
              didAwaitActCall ||
                ...
                ((didWarnNoAwaitAct = true),
                console.error(
                  'A component suspended inside an `act` scope, but the `act` call was not awaited. When testing React SearchFormItem that depend on asynchronous data, you must await the result:\n\nawait act(() => ...)',
                ));
            }),
