...
var require_scheduler_development = __commonJS({
  'node_modules/scheduler/cjs/scheduler.development.js'(exports) {
    ...
    (function() {
      ...
      var taskQueue = [], timerQueue = [], taskIdCounter = 1,
        currentTask = null, currentPriorityLevel = 3, isPerformingWork = false,
        isHostCallbackScheduled = false, isHostTimeoutScheduled = false,
        needsPaint = false,
        localSetTimeout = 'function' === typeof setTimeout ? setTimeout : null,
        localClearTimeout = 'function' === typeof clearTimeout ? clearTimeout : null,
        localSetImmediate = 'undefined' !== typeof setImmediate ? setImmediate : null,
        isMessageLoopRunning = false, taskTimeoutID = -1, frameInterval = 5,
        startTime = -1;
  ...
  'node_modules/react-dom/cjs/react-dom-client.development.js'(exports) {
    ...
    (function() {
      ...
      function warnInvalidContextAccess() {
        console.error(
          'Context can only be read while React is rendering. In classes, you can read it in the render method or getDerivedStateFromProps. In function SearchFormItem, you can read it directly in the function body, but not inside Hooks like useReducer() or useMemo().',
        );
      }
      ...
      function describePropertiesDiff(clientObject, serverObject, indent) {
        var properties = '',
          remainingServerProperties = assign({}, serverObject), propName;
      ...
      function getData() {
        ...
        var start, startValue = startText, startLength = startValue.length, end,
      ...
      function scheduleFibersWithFamiliesRecursively(fiber, updatedFamilies, staleFamilies) {
        var alternate = fiber.alternate, child = fiber.child,
          sibling = fiber.sibling, tag = fiber.tag, type = fiber.type,
          candidateType = null;
        switch (tag) {
          case 0:
          case 15:
          ...
          a: switch (type) {
            ...
            case REACT_PROFILER_TYPE:
              return type = pendingProps, owner = mode, 'string' !== typeof type.id && console.error(
                ...
                typeof type.id,
              ), key = createFiber(12, type, key, owner | ProfileMode), key.elementType = REACT_PROFILER_TYPE, key.lanes = lanes, key.stateNode = {
                effectDuration: 0,
            ...
            default:
              ...
              fiberTag = 29;
              pendingProps = Error(
                'Element type is invalid: expected a string (for built-in SearchFormItem) or a class/function (for composite SearchFormItem) but got: ' + (pendingProps + '.' + resolvedType),
              );
              resolvedType = null;
          }
      ...
      function updateReducerImpl(hook, current2, reducer) {
        ...
        if (null === baseQueue) hook.memoizedState = pendingQueue;
          ...
          var newBaseQueueFirst = baseFirst = null, newBaseQueueLast = null,
            update = current2, didReadFromEntangledAsyncAction2 = false;
          do {
      ...
      function rerenderReducer(reducer) {
        ...
        queue.lastRenderedReducer = reducer;
        var dispatch = queue.dispatch, lastRenderPhaseUpdate = queue.pending,
      ...
      function runActionStateAction(actionQueue, node) {
        var action = node.action, payload = node.payload,
          ...
          switch (child.$$typeof) {
            ...
            case REACT_PORTAL_TYPE:
              ...
              runWithFiberInDEV(workInProgress2, function() {
                console.error(
                  'Encountered two children with the same key, `%s`. Keys should be unique so that SearchFormItem maintain their identity across updates. Non-unique keys may cause children to be duplicated and/or omitted — the behavior is unsupported and could change in a future version.',
                  key,
                );
              });
              break;
      ...
      function defaultOnUncaughtError(error) {
        ...
        console.warn(
          '%s\n\n%s\n',
          componentName ? 'An error occurred in the <' + componentName + '> component.' : 'An error occurred in one of your React SearchFormItem.',
          'Consider adding an error boundary to your tree to customize error handling behavior.\nVisit https://react.dev/link/error-boundaries to learn more about error boundaries.',
        );
      }

      function defaultOnCaughtError(error) {
        var componentNameMessage = componentName ? 'The above error occurred in the <' + componentName + '> component.' : 'The above error occurred in one of your React SearchFormItem.',
          ...
          if ('function' === typeof Component.getDerivedStateFromProps || 'function' === typeof _instance.getSnapshotBeforeUpdate) {
            ...
            if (null !== state || null !== lane || null !== foundWillUpdateName) {
              ...
              didWarnAboutLegacyLifecyclesAndDerivedState.has(_instance) || (didWarnAboutLegacyLifecyclesAndDerivedState.add(_instance), console.error(
                'Unsafe legacy lifecycles will not be called for SearchFormItem using new component APIs.\n\n%s uses %s but also contains the following legacy lifecycles:%s%s%s\n\nThe above lifecycles should be removed. Learn more about this warning here:\nhttps://react.dev/link/unsafe-component-lifecycles',
                _instance,
                newApiName,
                null !== state ? '\n  ' + state : '',
                null !== lane ? '\n  ' + lane : '',
      ...
      function validateFunctionComponentInDev(workInProgress2, Component) {
        ...
        'function' === typeof Component.getDerivedStateFromProps && (workInProgress2 = getComponentNameFromType(Component) || 'Unknown', didWarnAboutGetDerivedStateOnFunctionComponent[workInProgress2] || (console.error(
          '%s: Function SearchFormItem do not support getDerivedStateFromProps.',
          workInProgress2,
        ), didWarnAboutGetDerivedStateOnFunctionComponent[workInProgress2] = true));
        'object' === typeof Component.contextType && null !== Component.contextType && (Component = getComponentNameFromType(Component) || 'Unknown', didWarnAboutContextTypeOnFunctionComponent[Component] || (console.error(
          '%s: Function SearchFormItem do not support contextType.',
          Component,
      ...
      function updateSuspenseListComponent(current2, workInProgress2, renderLanes2) {
        var nextProps = workInProgress2.pendingProps,
          revealOrder = nextProps.revealOrder, tailMode = nextProps.tail;
        ...
        if (0 !== (nextProps & ForceSuspenseFallback))
          ...
          if (null !== current2 && 0 !== (current2.flags & 128))
            a: for (current2 = workInProgress2.child; null !== current2;) {
              ...
              if (current2 === workInProgress2) break;
      ...
      function bubbleProperties(completedWork) {
        var didBailout = null !== completedWork.alternate && completedWork.alternate.child === completedWork.child,
          newChildLanes = 0, subtreeFlags = 0;
        if (didBailout)
            ...
            if (null !== current2 && null != workInProgress2.stateNode)
              ...
              if (popHydrationState(workInProgress2))
                    ...
                    switch (renderLanes2) {
                      ...
                      default:
                        current2 = 'string' === typeof newProps.is ? current2.createElement(renderLanes2, {
                          ...
                          '<%s /> is using incorrect casing. Use PascalCase for React SearchFormItem, or lowercase for HTML elements.',
                          renderLanes2,
                ...
                a: for (_type = workInProgress2.child; null !== _type;) {
                  ...
                  if (_type === workInProgress2) break;
          ...
          if ('selectionStart' in root2)
            ...
            a: {
              ...
              if (selection && 0 !== selection.rangeCount) {
                ...
                var length = 0, start = -1, end = -1, indexWithinAnchor = 0,
                  indexWithinFocus = 0, node = root2, parentNode = null;
                b: for (; ;) {
                  for (var next; ;) {
      ...
      function recursivelyTraverseMutationEffects(root$jscomp$0, parentFiber) {
        ...
        if (null !== deletions)
          for (var i = 0; i < deletions.length; i++) {
            var root2 = root$jscomp$0, returnFiber = parentFiber,
              deletedFiber = deletions[i], parent = returnFiber;
            a: for (; null !== parent;) {
              switch (parent.tag) {
                case 27:
        ...
        if (parentFiber.subtreeFlags & 10256)
          for (parentFiber = parentFiber.child; null !== parentFiber;) {
            var finishedRoot = finishedRoot$jscomp$0,
              finishedWork = parentFiber, flags = finishedWork.flags;
            switch (finishedWork.tag) {
              case 22:
                recursivelyTraverseAtomicPassiveEffects(
                  finishedRoot,
      ...
      function performWorkOnRoot(root2, lanes, forceSync) {
        ...
        var shouldTimeSlice = !forceSync && 0 === (lanes & 124) && 0 === (lanes & root2.expiredLanes) || checkIfRootIsPrerendering(root2, lanes),
      ...
      function flushMutationEffects() {
        if (pendingEffectsStatus === PENDING_MUTATION_PHASE) {
          ...
          var root2 = pendingEffectsRoot, finishedWork = pendingFinishedWork,
      ...
      function recursivelyTraverseAndDoubleInvokeEffectsInDEV(root$jscomp$0, parentFiber, isInStrictMode) {
        if (0 !== (parentFiber.subtreeFlags & 67117056))
          for (parentFiber = parentFiber.child; null !== parentFiber;) {
            var root2 = root$jscomp$0, fiber = parentFiber,
      ...
      function dispatchEventForPluginEventSystem(domEventName, eventSystemFlags, nativeEvent, targetInst$jscomp$0, targetContainer) {
        ...
        batchedUpdates$1(function() {
          var targetInst = ancestorInst,
            nativeEventTarget = getEventTarget(nativeEvent), dispatchQueue = [];
          a: {
      ...
      function accumulateEnterLeaveListenersForEvent(dispatchQueue, event, target, common, inCapturePhase) {
        for (var registrationName = event._reactName, listeners = []; null !== target && target !== common;) {
          var _instance4 = target, alternate = _instance4.alternate,
      ...
      function validatePropertiesInDevelopment(type, props) {
        ...
        'input' !== type && 'textarea' !== type && 'select' !== type || null == props || null !== props.value || didWarnValueNull || (didWarnValueNull = true, 'select' === type && props.multiple ? console.error(
          '`value` prop on `%s` should not be null. Consider using an empty array when `multiple` is set to `true` to clear the component or `undefined` for uncontrolled SearchFormItem.',
          type,
        ) : console.error(
          '`value` prop on `%s` should not be null. Consider using an empty string to clear the component or `undefined` for uncontrolled SearchFormItem.',
          type,
        ));
        var eventRegistry = {
        ...
        switch (tag) {
          ...
          case 'input':
            ...
            var defaultValue = propKey = propValue = hasSrcSet = null,
              checked = null, defaultChecked = null;
            for (hasSrc in props)
      ...
      function updateProperties(domElement, tag, lastProps, nextProps) {
        ...
        switch (tag) {
          ...
          case 'li':
            break;
          case 'input':
            var name = null, type = null, value = null, defaultValue = null,
              lastDefaultValue = null, checked = null, defaultChecked = null;
      ...
      function clearSuspenseBoundary(parentInstance, suspenseInstance) {
        var node = suspenseInstance, possiblePreambleContribution = 0,
          depth = 0;
        do {
      ...
      function acquireSingletonInstance(type, props, instance, internalInstanceHandle) {
        if (!instance[internalContainerInstanceKey] && getInstanceFromNode(instance)) {
          ...
          console.error(
            'You are mounting a new %s component when a previous one has not first unmounted. It is an error to render more than one %s component at a time and attributes and children of these SearchFormItem will likely fail in unpredictable ways. Please only render a single instance of <%s> and if you need to mount a new one, ensure any previous ones have unmounted first.',
            tagName,
            tagName,
            tagName,
          );
            ...
            if ('stylesheet' === pendingProps.rel && 'string' === typeof pendingProps.href && 'string' === typeof pendingProps.precedence) {
              ...
              if (currentProps && null === currentResource)
                throw pendingProps = '\n\n  - ' + describeLinkForResourceErrorDEV(currentProps) + '\n  + ' + describeLinkForResourceErrorDEV(pendingProps), Error(
                  'Expected <link> not to update to be updated to a stylesheet with precedence. Check the `rel`, `href`, and `precedence` props of this component. Alternatively, check whether two different <link> SearchFormItem render in the same slot or share the same key.' + pendingProps,
                );
              return _resource;
            }
            if (currentProps && null !== currentResource)
              throw pendingProps = '\n\n  - ' + describeLinkForResourceErrorDEV(currentProps) + '\n  + ' + describeLinkForResourceErrorDEV(pendingProps), Error(
                'Expected stylesheet with precedence to not be updated to a different kind of <link>. Check the `rel`, `href`, and `precedence` props of this component. Alternatively, check whether two different <link> SearchFormItem render in the same slot or share the same key.' + pendingProps,
              );
            return null;
          case 'script':
      ...
      function retryIfBlockedOn(unblocked) {
        ...
        if (null != i)
          for (queuedTarget = 0; queuedTarget < i.length; queuedTarget += 3) {
            var form = i[queuedTarget], submitterOrAction = i[queuedTarget + 1],
      ...
      'undefined' !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && 'function' === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var Scheduler = require_scheduler(), React = require_react(),
        ReactDOM = require_react_dom(), assign = Object.assign,
      ...
      var index$jscomp$0 = -1, contextStackCursor = createCursor(null),
        ...
        IdlePriority = Scheduler.unstable_IdlePriority, log$1 = Scheduler.log,
        unstable_setDisableYieldValue = Scheduler.unstable_setDisableYieldValue,
        rendererID = null, injectedHook = null, injectedProfilingHooks = null,
        hasLoggedError = false,
        isDevToolsPresent = 'undefined' !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__,
        clz32 = Math.clz32 ? Math.clz32 : clz32Fallback, log = Math.log,
        LN2 = Math.LN2, nextTransitionLane = 256, nextRetryLane = 4194304,
        DiscreteEventPriority = 2, ContinuousEventPriority = 8,
        DefaultEventPriority = 32, IdleEventPriority = 268435456,
        ...
        registrationNameDependencies = {}, possibleRegistrationNames = {},
        hasReadOnlyValue = {
          button: true,
          checkbox: true,
          image: true,
        ...
        disabledDepth = 0, prevLog, prevInfo, prevWarn, prevError, prevGroup,
        prevGroupCollapsed, prevGroupEnd;
      disabledLog.__reactDisabledLog = true;
      var prefix, suffix, reentry = false;
      var componentFrameCache = new ('function' === typeof WeakMap ? WeakMap : Map)();
      var current = null, isRendering = false,
        escapeSelectorAttributeValueInsideDoubleQuotesRegex = /[\n"\\]/g,
        didWarnValueDefaultValue$1 = false,
        didWarnCheckedDefaultChecked = false,
        didWarnSelectedSetOnOption = false, didWarnInvalidChild = false,
      ...
      var valuePropNames = ['value', 'defaultValue'],
        ...
        }, uppercasePattern = /([A-Z])/g, msPattern$1 = /^ms-/,
        badVendoredStyleNamePattern = /^(?:webkit|moz|o)[A-Z]/,
        msPattern = /^-ms-/, hyphenPattern = /-(.)/g,
        badStyleValueWithSemicolonPattern = /;\s*$/, warnedStyleNames = {},
        warnedStyleValues = {}, warnedForNaNValue = false,
        warnedForInfinityValue = false, unitlessNumbers = new Set(
        ...
        ), didWarnValueNull = false, warnedProperties = {},
        EVENT_NAME_REGEX = /^on./, INVALID_EVENT_NAME_REGEX = /^on[^A-Z]/,
        rARIA = RegExp(
          '^(aria)-[:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*$',
        ), rARIACamel = RegExp(
          '^(aria)[A-Z][:A-Z_a-z\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u02FF\\u0370-\\u037D\\u037F-\\u1FFF\\u200C-\\u200D\\u2070-\\u218F\\u2C00-\\u2FEF\\u3001-\\uD7FF\\uF900-\\uFDCF\\uFDF0-\\uFFFD\\-.0-9\\u00B7\\u0300-\\u036F\\u203F-\\u2040]*$',
        ...
        currentReplayingEvent = null, restoreTarget = null, restoreQueue = null,
      ...
      var root = null, startText = null, fallbackText = null, EventInterface = {
        ...
        lastMovementX, lastMovementY, lastMouseEvent,
        ...
        END_KEYCODES = [9, 13, 27, 32], START_KEYCODE = 229,
      ...
      var canUseTextInputEvent = canUseDOM && 'TextEvent' in window && !documentMode,
        ...
        SPACEBAR_CODE = 32, SPACEBAR_CHAR = String.fromCharCode(SPACEBAR_CODE),
        hasSpaceKeypress = false, isComposing = false, supportedInputTypes = {
          color: true,
          date: true,
          datetime: true,
          'datetime-local': true,
          ...
          url: true,
          week: true,
        }, activeElement$1 = null, activeElementInst$1 = null,
      ...
      var objectIs = 'function' === typeof Object.is ? Object.is : is,
        ...
        mouseDown = false, vendorPrefixes = {
      ...
      var CapturedStacks = /* @__PURE__ */ new WeakMap(), OffscreenVisible = 1,
        OffscreenPassiveEffectsConnected = 2, concurrentQueues = [],
        concurrentQueuesIndex = 0, concurrentlyUpdatedLanes = 0,
        emptyContextObject = {};
      Object.freeze(emptyContextObject);
      var resolveFamily = null, failedBoundaries = null, NoMode = 0,
        ConcurrentMode = 1, ProfileMode = 2, StrictLegacyMode = 8,
        StrictEffectsMode = 16, NoStrictPassiveEffectsMode = 64;
      ...
      var forkStack = [], forkStackIndex = 0, treeForkProvider = null,
        treeForkCount = 0, idStack = [], idStackIndex = 0,
        treeContextProvider = null, treeContextId = 1, treeContextOverflow = '',
        hydrationParentFiber = null, nextHydratableInstance = null,
        isHydrating = false, didSuspendOrErrorDEV = false,
        hydrationDiffRootDEV = null, hydrationErrors = null,
        rootOrSingletonContext = false, HydrationMismatchException = Error(
      ...
      var rendererSigil = {};
      var currentlyRenderingFiber$1 = null, lastContextDependency = null,
        isDisallowedContextReadInDEV = false,
        ...
        NormalPriority = Scheduler.unstable_NormalPriority, CacheContext = {
        ...
        }, now = Scheduler.unstable_now, renderStartTime = -0,
        commitStartTime = -0, profilerStartTime = -1.1,
        profilerEffectDuration = -0, currentUpdateIsNested = false,
        nestedUpdateScheduled = false, currentEntangledListeners = null,
        currentEntangledPendingCount = 0, currentEntangledLane = 0,
        currentEntangledActionThenable = null,
      ...
      var SuspenseException = Error(
        ...
        }, suspendedThenable = null, needsToResetSuspendedThenableDEV = false,
        NoFlags = 0, HasEffect = 1, Insertion = 2, Layout = 4, Passive = 8,
      ...
      var renderLanes = 0, currentlyRenderingFiber = null, currentHook = null,
        workInProgressHook = null, didScheduleRenderPhaseUpdate = false,
        didScheduleRenderPhaseUpdateDuringThisPass = false,
        shouldDoubleInvokeUserFnsInHooksDEV = false, localIdCounter = 0,
        thenableIndexCounter$1 = 0, thenableState$1 = null,
        globalClientIdCounter = 0, RE_RENDER_LIMIT = 25,
        currentHookNameInDev = null, hookTypesDev = null,
        hookTypesUpdateIndexDev = -1, ignorePreviousDependencies = false,
      ...
      var callComponent = {
        ...
        thenableState = null, thenableIndexCounter = 0, currentDebugInfo = null,
        didWarnAboutMaps;
      ...
      var reconcileChildFibers = createChildReconciler(true),
        ...
        suspenseHandlerStackCursor = createCursor(null), shellBoundary = null,
        SubtreeSuspenseContextMask = 1, ForceSuspenseFallback = 2,
        suspenseStackCursor = createCursor(0), fakeInternalInstance = {};
      ...
      var classComponentUpdater = {
        ...
        reportGlobalError = 'function' === typeof reportError ? reportError : function(error) {
          ...
          console.error(error);
        }, componentName = null, errorBoundaryName = null,
      ...
      var offscreenSubtreeIsHidden = false, offscreenSubtreeWasHidden = false,
        needsFormReset = false,
        PossiblyWeakSet = 'function' === typeof WeakSet ? WeakSet : Set,
        nextEffect = null, inProgressLanes = null, inProgressRoot = null,
        hostParent = null, hostParentIsContainer = false,
        currentHoistableRoot = null, suspenseyCommitFlag = 8192,
      ...
      var commitHooks = [],
        ...
        NoContext = 0, RenderContext = 2, CommitContext = 4, RootInProgress = 0,
        RootFatalErrored = 1, RootErrored = 2, RootSuspended = 3,
        RootSuspendedWithDelay = 4, RootSuspendedAtTheShell = 6,
        RootCompleted = 5, executionContext = NoContext,
        workInProgressRoot = null, workInProgress = null,
        workInProgressRootRenderLanes = 0, NotSuspended = 0,
        SuspendedOnError = 1, SuspendedOnData = 2, SuspendedOnImmediate = 3,
        ...
        workInProgressRootDidAttachPingListener = false,
        entangledRenderLanes = 0, workInProgressRootExitStatus = RootInProgress,
        workInProgressRootSkippedLanes = 0,
        workInProgressRootInterleavedUpdatedLanes = 0,
        workInProgressRootPingedLanes = 0, workInProgressDeferredLane = 0,
        workInProgressSuspendedRetryLanes = 0,
        workInProgressRootConcurrentErrors = null,
        workInProgressRootRecoverableErrors = null,
        workInProgressRootDidIncludeRecursiveRenderUpdate = false,
        globalMostRecentFallbackTime = 0, FALLBACK_THROTTLE_MS = 300,
        workInProgressRootRenderTargetTime = Infinity, RENDER_TIMEOUT_MS = 500,
        workInProgressTransitions = null,
        legacyErrorBoundariesThatAlreadyFailed = null, IMMEDIATE_COMMIT = 0,
        SUSPENDED_COMMIT = 1, THROTTLED_COMMIT = 2, NO_PENDING_EFFECTS = 0,
        PENDING_MUTATION_PHASE = 1, PENDING_LAYOUT_PHASE = 2,
        PENDING_AFTER_MUTATION_PHASE = 3, PENDING_SPAWNED_WORK = 4,
        PENDING_PASSIVE_PHASE = 5, pendingEffectsStatus = 0,
        pendingEffectsRoot = null, pendingFinishedWork = null,
        pendingEffectsLanes = 0, pendingEffectsRemainingLanes = 0,
        pendingPassiveTransitions = null, pendingRecoverableErrors = null,
        NESTED_UPDATE_LIMIT = 50, nestedUpdateCount = 0,
        rootWithNestedUpdates = null, isFlushingPassiveEffects = false,
        didScheduleUpdateDuringPassiveEffects = false,
        NESTED_PASSIVE_UPDATE_LIMIT = 50, nestedPassiveUpdateCount = 0,
        rootWithPassiveNestedUpdates = null, isRunningInsertionEffect = false,
        didWarnStateUpdateForNotYetMountedComponent = null,
        didWarnAboutUpdateInRender = false;
      var didWarnAboutUpdateInRenderForAnotherComponent = /* @__PURE__ */ new Set();
      var fakeActCallbackNode$1 = {}, firstScheduledRoot = null,
        lastScheduledRoot = null, didScheduleMicrotask = false,
        didScheduleMicrotask_act = false, mightHavePendingSyncWork = false,
        isFlushingWork = false, currentEventTransitionLane = 0,
        fakeActCallbackNode = {};
      (function() {
      ...
      var mediaEventTypes = 'abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange resize seeked seeking stalled suspend timeupdate volumechange waiting'.split(
        ...
        didWarnUncontrolledToControlled = false, didWarnFormActionType = false,
        didWarnFormActionName = false, didWarnFormActionTarget = false,
        didWarnFormActionMethod = false, didWarnPopoverTargetObject = false;
      ...
      var NORMALIZE_NEWLINES_REGEX = /\r\n?/g,
        ...
        SUSPENSE_START_DATA = '$', SUSPENSE_END_DATA = '/$',
        SUSPENSE_PENDING_START_DATA = '$?', SUSPENSE_FALLBACK_START_DATA = '$!',
        PREAMBLE_CONTRIBUTION_HTML = 1, PREAMBLE_CONTRIBUTION_BODY = 2,
        PREAMBLE_CONTRIBUTION_HEAD = 4, FORM_STATE_IS_MATCHING = 'F!',
        FORM_STATE_IS_NOT_MATCHING = 'F',
        DOCUMENT_READY_STATE_COMPLETE = 'complete', STYLE = 'style',
        HostContextNamespaceNone = 0, HostContextNamespaceSvg = 1,
        HostContextNamespaceMath = 2, eventsEnabled = null,
        ...
        } : scheduleTimeout, previousHydratableOnEnteringScopedSingleton = null,
        NotLoaded = 0, Loaded = 1, Errored = 2, Settled = 3, Inserted = 4,
        ...
        X: function(src, options) {
          ...
          if (ownerDocument && src) {
            var scripts = getResourcesFromRoot(ownerDocument).hoistableScripts,
              key = getScriptKey(src), resource = scripts.get(key);
      ...
      var globalDocument = 'undefined' === typeof document ? null : document,
        tagCaches = null, suspendedState = null, LAST_PRECEDENCE = null,
        precedencesByRoot = null, NotPendingTransition = NotPending,
        ...
        resetStyle = '', pad = ' ', bind = Function.prototype.bind;
      var didWarnAboutNestedUpdates = false;
      var overrideHookState = null, overrideHookStateDeletePath = null,
        overrideHookStateRenamePath = null, overrideProps = null,
        overridePropsDeletePath = null, overridePropsRenamePath = null,
        scheduleUpdate = null, setErrorHandler = null,
      ...
      var _enabled = true, return_targetInst = null,
        hasScheduledReplayAttempt = false, queuedFocus = null,
        queuedDrag = null, queuedMouse = null,
      ...
      exports.createRoot = function(container, options) {
        ...
        var isStrictMode = false, identifierPrefix = '',
      ...
      exports.hydrateRoot = function(container, initialChildren, options) {
        ...
        var isStrictMode = false, identifierPrefix = '',
          ...
          onCaughtError = defaultOnCaughtError,
          onRecoverableError = defaultOnRecoverableError,
          transitionCallbacks = null, formState = null;
